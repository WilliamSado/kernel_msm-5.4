...
DEFCONFIG_NAME="vendor/lahaina-qgki_defconfig vendor/xiaomi_QGKI.config vendor/star_QGKI.config";
...
use_prebuilt_dlkm(){
    DLKM_BUILD_PATH=/srv/media/WD/pe/out/target/product/star/obj/PACKAGING/target_files_intermediates/aosp_star-target_files-eng.credits/IMAGES/
